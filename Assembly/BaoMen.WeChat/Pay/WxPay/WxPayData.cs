...
namespace BaoMen.WeChat.Pay.WxPay
{
    ...
    public class WxPayData
    {
        ...
        //public WxPayData(Config config)
        //{
        //    this.config = config;
        //}
        ...
        * @throws WxPayException
        */
        public SortedDictionary<string, object> FromXml(string xml, Config config, bool checkSign = true)
        {
        ...
        */
        public string ToJson()
        {
            ...
            // return jsonStr;
            return System.Text.Json.JsonSerializer.Serialize(m_values);
        }
        ...
        * 正确返回true，错误抛异常
        */
        public bool CheckSign(Config config)
        {
            //如果没有设置签名，则跳过检测
            if (!IsSet("sign"))
            {
