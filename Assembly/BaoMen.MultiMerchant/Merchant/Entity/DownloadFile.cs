...
namespace BaoMen.MultiMerchant.Merchant.Entity
{
    ...
    /// </summary>
	[Serializable]
    [DatabaseEntity(TableName = "mch_download_file")]
    ...
    public partial class DownloadFile : Util.IMerchantData
    {

    }

    public partial class DownloadFileFilter : Util.IMerchantFilter
    {
