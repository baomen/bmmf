...
namespace BaoMen.MultiMerchant.Merchant.DataAccess
{
    ...
    public partial class OperateHistory : DapperDataAccess<int,Entity.OperateHistory, Entity.OperateHistoryFilter>
    {
        ...
        /// 数据库表名
        /// </summary>
        protected override string TableName { get { return "mch_operate_history"; } }
        ...
        {
            string sql = $"INSERT INTO {TableName} (MerchantId,UserId,Type,OperateTime,AssemblyName,EntityType,RelatedId,Value,Description) VALUES (@MerchantId,@UserId,@Type,@OperateTime,@AssemblyName,@EntityType,@RelatedId,@Value,@Description)";
        ...
        {
            string sql = $"UPDATE {TableName} SET MerchantId=@MerchantId,UserId=@UserId,Type=@Type,OperateTime=@OperateTime,AssemblyName=@AssemblyName,EntityType=@EntityType,RelatedId=@RelatedId,Value=@Value,Description=@Description WHERE Id=@Id";
            return new DapperCommand()
            {
                CommandText = sql,
                Parameters = item
        ...
        {
            string sql = $"SELECT {TableName}.Id,{TableName}.MerchantId,{TableName}.UserId,{TableName}.Type,{TableName}.OperateTime,{TableName}.AssemblyName,{TableName}.EntityType,{TableName}.RelatedId,{TableName}.Value,{TableName}.Description FROM {TableName}";
            sql += " WHERE Id=@Id";
            return new DapperCommand()
            {
                CommandText = sql,
